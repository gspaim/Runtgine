...
Human Player. The Runner SHALL apply the verb **before** claim acquire:
`deny` never claims; `approval-required` pauses without holding a
claim; grant then acquire then Execute.
