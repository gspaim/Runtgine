...
Blast Radius: `docs/25-blast-radius-v0.md` + change
`openspec/changes/025-blast-radius/` — CONFIRMED v0 (G-99..G-104);
codigo = slice 13.
...
19. Blast Radius — CONFIRMED v0 em `25` + OpenSpec `025-blast-radius` — spec; codigo = slice 13
20. TUI GRAPH / walk Blast←Graph / mais Players — so apos nova promocao em `04`
